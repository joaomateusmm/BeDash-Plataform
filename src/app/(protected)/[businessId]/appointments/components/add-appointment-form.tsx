  ...
  return (
    <DialogContent className="sm:max-w-[500px]">
      <DialogHeader>
        ...
        <DialogDescription>
          Crie um novo agendamento para sua empresa.
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
                ...
                {profissionais.length === 0 ? (
                  <div className="w-full">
                    <p className="text-muted-foreground text-sm">
                      Você precisa criar pelo menos um funcionário antes de
                      criar agendamentos. Vá para a página{" "}
                      <a className="text-purple-500" href="/profissionais">
                        Funcionários
                      </a>
                      .
                    </p>
