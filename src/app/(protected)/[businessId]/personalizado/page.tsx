...
interface PersonalizadoPageProps {
  params: Promise<{
    businessId: string;
  }>;
}

const PersonalizadoPage = async ({ params }: PersonalizadoPageProps) => {
    ...
    <PageContainer>
      ...
      <PageHeader>
        <PageHeaderContent>
          ...
          <PageDescription>
            Configure campanhas personalizadas com automações avançadas e
