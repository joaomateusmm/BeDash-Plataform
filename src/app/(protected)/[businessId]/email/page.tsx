...
import { Mail, Construction, Clock } from "lucide-react";
...
const EmailPage = async ({ params }: EmailPageProps) => {
    ...
    <PageContainer>
      ...
      <PageHeader>
        <PageHeaderContent>
          ...
          <PageDescription>
            Crie e gerencie campanhas de email marketing para seus clientes.
          </PageDescription>
        </PageHeaderContent>
      </PageHeader>
