...
const UpsertDoctorForm = ({
  ...
  if (funcoes.length === 0) {
    return (
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Nenhuma função encontrada</DialogTitle>
          <DialogDescription>
            Você precisa criar pelo menos uma função antes de adicionar
            funcionários. Vá para a página de funções e crie algumas funções
            primeiro.
          </DialogDescription>
        </DialogHeader>
      </DialogContent>
